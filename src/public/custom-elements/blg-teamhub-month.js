...
(function () {
  ...
  var CSS = [
    ...
    '  text-transform:uppercase;color:var(--muted);margin:12px 2px 6px;font-size:10px}',
    ...
    '.ag-t b{display:block;font-family:var(--f-head);font-size:13px;font-weight:700}',
    '.ag-t span{display:block;font-size:11.5px;color:var(--muted-2)}',
    '.ag-rail{flex:none;width:4px;border-radius:2px}',
    '.ag-m{min-width:0}',
    '.ag-m b{display:block;font-family:var(--f-head);font-size:13px;font-weight:600;',
    '  line-height:1.25}',
    '.ag-m span{display:block;font-size:11.5px;color:var(--muted);margin-top:1px}',
    ...
    '.fdtot .big{font-family:var(--f-head);font-size:16px;font-weight:700;',
    ...
    '  padding:4px 10px;font-size:11.5px;color:var(--muted);white-space:nowrap}',
    ...
    '.fdd b{display:block;font-family:var(--f-head);font-size:13.5px;font-weight:700;',
    ...
    '.fdt{flex:none;width:38px;font-size:11.5px;color:var(--muted);',
    '  font-variant-numeric:tabular-nums}',
    '.fdn{flex:1;min-width:0;font-size:13px;font-weight:500;overflow:hidden;',
    '  text-overflow:ellipsis;white-space:nowrap}',
    '.fdn.gap{color:#B4262A;font-weight:600}',
    '.fdn small{display:block;font-size:11px;color:var(--muted-2);font-weight:400}',
    '.fdh{flex:none;font-size:12px;font-weight:600;font-variant-numeric:tabular-nums;',
    ...
    '.dev .n{font-family:var(--f-head);font-size:11.5px;font-weight:600;line-height:1.2;',
    ...
    '  font-weight:600;font-family:inherit;cursor:pointer;position:relative;font-size:9px}',
    ...
    '  font-size:13.5px;border:0;background:none;border-radius:10px;font-family:inherit;',
    ...
    /* The base size everything unsized inherits — dropping it here pulls
       down the odd label and option that has no size of its own. */
    '  :host{font-size:13px}',
    ...
    '  .row-t{font-size:12.5px}',
    '  .row-s{font-size:10.5px;margin-top:2px}',
    ...
    '  .pill{height:20px;padding:0 7px;font-size:9.5px}',
    ...
    '  .btn{height:40px;padding:0 14px;font-size:10px}',
    '  .btn-sm{height:36px;padding:0 11px;font-size:9.5px}',
    '  .vseg button{padding:10px 13px;font-size:11.5px}',
    '  .tbl select,.tbl input{height:38px}',
    '  .signout{height:36px;padding:0 11px;font-size:10px}',
    '  .hedit input{height:38px;width:68px}',
    '  .linkbtn{display:inline-block;padding:9px 4px}',
    '  .label{font-size:9px}',
    '  .note-line{font-size:11px;padding-top:10px;padding-bottom:12px}',
